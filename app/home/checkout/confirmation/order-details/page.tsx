...
// // Mock data to simulate the structure of a saved order object
// const mockOrder = {
//     id: 'HH123456',
...
//         city: 'Handcrafted City',
//         zip: '10001',
//         email: 'jane.doe@example.com',
//     },
//     items: [
//         { id: 1, name: 'Handmade Sage Soap Bar', price: 12.99, quantity: 2, image: '/images/products/soap.jpg' },
//         { id: 3, name: 'Minimalist Leather Wallet', price: 90.00, quantity: 1, image: '/images/products/wallet.jpg' },
//         { id: 5, name: 'Ceramic Tea Mug (Blue)', price: 20.00, quantity: 1, image: '/images/products/mug.jpg' },
//     ],
// };
...
//             <p className="text-gray-500 mb-8">Order <span className="font-bold text-[#2C3E50]">#{mockOrder.id}</span> placed on {mockOrder.date}</p>

//             <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
                
//                 {/* === Order Items List (Col 1 & 2) === */}
//                 <div className="lg:col-span-2 space-y-6">
//                     <h2 className="text-2xl font-serif text-[#2C3E50] border-b pb-3">Items Ordered</h2>
...
//                                 {mockOrder.shippingAddress.city}, {mockOrder.shippingAddress.zip}<br />
